  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col flex-1 bg-[var(--color-bg-primary)]">
        {/* Header - aligns with main header bottom */}
        <div className="
        ...
        ">
          ...
          <div className="flex items-center gap-4 chatbot-mobile-controls">
            {/* Reset button */}
            <button
              onClick={onReset}
              className="
      ...
      {/* Filler - 20% of viewport (adjusted for header) */}
      <div className="h-[20vh] bg-[var(--color-bg-secondary)]"></div>
    </div>
  );
}
